...
const deployLogDir = process.env.DEPLOY_LOG_DIR || "/srv/frc1884-scouting/logs";
const deployLogFile =
  process.env.DEPLOY_LOG_FILE || `${deployLogDir}/github-webhook.log`;
const repoDir = process.env.REPO_DIR || "/srv/frc1884-scouting";
const expectedRepo = process.env.GITHUB_REPOSITORY || "FRC1884/frc1884-scouting";
const expectedRef = process.env.GITHUB_DEPLOY_REF || "refs/heads/main";
const lockFile = process.env.DEPLOY_LOCK_FILE || "/tmp/frc1884-scouting-deploy.lock";
